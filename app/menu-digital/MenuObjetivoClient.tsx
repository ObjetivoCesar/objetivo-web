                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col border-2 border-gray-100 hover:border-[#FF6B00]/30">
                            ...
                            <div className="p-6 pt-0">
                                <Link
                                    href={`/pago?amount=250&description=${encodeURIComponent("Plan Emprendedor - Menú Digital")}&backTo=/menu-digital#cuanto-cuesta-tener-un-menu-digital-que-aparezca-en-google`}
                        ...
                        <div className="bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col border-2 border-[#FF6B00] relative transform lg:scale-105">
                            ...
                            <div className="p-6 pt-0">
                                <Link
                                    href={`/pago?amount=500&description=${encodeURIComponent("Plan Crecimiento - Menú Digital")}&backTo=/menu-digital#cuanto-cuesta-tener-un-menu-digital-que-aparezca-en-google`}
                        ...
                        <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col border-2 border-gray-100 hover:border-[#FF6B00]/30">
                            ...
                            <div className="p-6 pt-0">
                                <Link
                                    href={`/pago?amount=700&description=${encodeURIComponent("Plan Pro - Menú Digital")}&backTo=/menu-digital#cuanto-cuesta-tener-un-menu-digital-que-aparezca-en-google`}
                                    className="block w-full bg-gray-900 text-white text-center font-bold py-3 px-6 rounded-lg hover:bg-[#FF6B00] transition-colors"
                                >
                                    <span className="flex flex-col items-center justify-center space-y-1">
                                        <span className="text-lg">Elegir Plan</span>
                        ...
                        <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col border-2 border-gray-100 hover:border-[#FF6B00]/30">
                            ...
                            <div className="p-6 pt-0">
                                <Link
                                    href={`/pago?amount=1000&description=${encodeURIComponent("Plan Posicionamiento - Menú Digital")}&backTo=/menu-digital#cuanto-cuesta-tener-un-menu-digital-que-aparezca-en-google`}
                                    className="block w-full bg-gray-900 text-white text-center font-bold py-3 px-6 rounded-lg hover:bg-[#FF6B00] transition-colors"
                                >
                                    <span className="flex flex-col items-center justify-center space-y-1">
                                        <span className="text-lg">Elegir Plan</span>
