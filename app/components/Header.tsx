    ...
    { 
      ...
      submenu: [
        ...
        { 
          ...
          href: '/blog/marketing-para-pymes',
          image: '/images/blog_cesar_bn.webp',
          description: 'Estrategias para impulsar tu negocio'
        },
        { 
          name: 'Automatización de Ventas', 
          href: '/blog/automatizacion-de-ventas',
          image: '/images/Diseño Web.webp',
          description: 'Optimiza tus ventas'
        },
        { 
          name: 'Posicionamiento en Google', 
          href: '/blog/posicionamiento-en-google',
          image: '/images/busquedas_mensuales.webp',
          description: 'Aumenta tu visibilidad'
        },
        { 
          name: 'ActivaQR Gastronomía', 
          href: '/blog/activaqr-gastronomia',
          image: '/images/analisis-estrategico.webp',
          description: 'Soluciones para restaurantes'
        },
        { 
          name: 'ActivaQR Networking', 
          href: '/blog/activaqr-networking',
          image: '/images/testimonios.webp',
          description: 'Conexiones profesionales'
        },
        { 
          name: 'Casos de Éxito', 
          href: '/blog/casos-de-exito',
          image: '/images/negocio_resultados.webp',
