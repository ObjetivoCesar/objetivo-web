              ...
              <div className="p-8 pt-0">
                ...
                <div className="mt-12 pt-8 border-t border-gray-200">
                  ...
                  <div className="flex space-x-4">
                    <a 
                      href="https://www.facebook.com/CesarReyes.Pymes/?locale=es_LA" 
                      target="_blank" 
                    ...
                    <a 
                      href="https://www.linkedin.com/in/cesarreyesjaramillo/"
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-primary hover:text-primary/80"
                    ...
                    <a 
                      href="https://www.instagram.com/cesarreyesjaramillo/?hl=es-la"
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-primary hover:text-primary/80"
                      aria-label="Instagram de César Reyes"
                    >
                      <span className="sr-only">Instagram</span>
                      <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fillRule="evenodd" d="M12.315 2c2.43 0 2.715.01 3.655.049 1.01.045 1.785.176 2.454.43 1.018.397 1.787.973 2.607 1.792.82.82 1.396 1.591 1.793 2.607.254.67.385 1.444.43 2.454.039.94.049 1.224.049 3.655 0 2.43-.01 2.715-.049 3.655-.045 1.01-.176 1.785-.43 2.454-.397 1.018-.973 1.787-1.792 2.607-.82-.82-1.591 1.396-2.607 1.793-.67.254-1.444.385-2.454.43-.94.039-1.224.049-3.655.049-2.43 0-2.715-.01-3.655-.049-1.01-.045-1.785-.176-2.454-.43-1.018-.397-1.787-.973-2.607-1.792-.82-.82-1.591-1.396-2.607-1.793-.67-.254-1.444-.385-2.454-.43.94-.039 1.224-.049 3.655-.049zM12 7a5 5 0 100 10 5 5 0 000-10zm0 8.167a3.167 3.167 0 110-6.334 3.167 3.167 0 010 6.334z" clipRule="evenodd" />
                      </svg>
                    </a>
                    <a 
                      href="https://www.youtube.com/@CesarReyesJaramillo/videos"
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-primary hover:text-primary/80"
                      aria-label="YouTube de César Reyes"
                    >
                      <span className="sr-only">YouTube</span>
                      <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path d="M19.613 5.485c-.75-.205-1.936-.453-3.232-.577C14.717 4.793 12 4.75 12 4.75s-2.717.043-4.38.158c-1.296.124-2.482.372-3.232.577C3.127 6.133 2 7.26 2 8.528v6.944c0 1.268 1.127 2.395 2.388 2.686.75.205 1.936.453 3.232.577C9.283 19.207 12 19.25 12 19.25s2.717-.043 4.38-.158c1.296-.124 2.482-.372 3.232-.577C20.873 17.867 22 16.74 22 15.472V8.528c0-1.268-1.127-2.395-2.388-2.686zM10 15.25V8.75L16 12l-6 3.25z" />
                      </svg>
                    </a>
                  </div>
                </div>
