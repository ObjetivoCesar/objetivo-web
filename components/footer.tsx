      ...
      <div className="container mx-auto px-4 md:px-0">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start md:justify-between gap-6">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <p className="text-sm text-gray-400">© 2026 César Reyes. Todos los derechos reservados.</p>
          </div>
          ...
          <div className="flex flex-col items-center md:items-end text-center md:text-right gap-2">
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/CesarReyes.Pymes/?locale=es_LA" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-gray-400 hover:text-white text-lg">
              ...
              <a href="https://www.instagram.com/cesarreyesjaramillo/?hl=es-la" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-400 hover:text-white text-lg">
              ...
              <a href="https://www.linkedin.com/in/cesarreyesjaramillo/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-gray-400 hover:text-white text-lg">
              ...
              <a href="https://www.youtube.com/@CesarReyesJaramillo/videos" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-gray-400 hover:text-white text-lg">
